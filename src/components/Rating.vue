<template>
    <div class="rating">
        <div v-if="!rating.average">
            暂无评分
        </div>
        <div v-else>
            <b v-for="n in fullstar">
                <span class="star-full"></span>
            </b>
            <b v-for="n in halfstar">
                <span class="star-half"></span>
            </b>
            <b v-for="n in graystar">
...
<script>
    export default{
        ...
        created(){
            ...
            this.fullstar = Math.floor(average / 2)
            this.halfstar = average % 2 === 0 ? 0 : 1
            this.graystar = 5 - this.fullstar - this.halfstar
        }
    }
</script>
